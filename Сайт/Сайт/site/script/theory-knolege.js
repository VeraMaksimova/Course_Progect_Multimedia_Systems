...
let knowledge = [
	...
	[
		...
		'<img class="dialog__image" width="100px" height="140px" src="img/srtucture/squier-fsr-classic-vibe-60s-custom-esquire-lrl-black-6.jpg"/>',
	],
	[
		'струны',
		'являются ',
		'непосредственным источником звуковых колебаний, возникающих под воздействием щипков гитариста. Могут различаться по толщине (от 0,08 мм и менее до 0,58 мм и более) и материалу (хром, никель, сталь и т. д.). Состоят из керна, или сердечника (жилы), а также оплётки и бойка.',
	],
	[
		'струна',
		'- это',
	...
	[
		'гриф',
		'является',
		' продолговатым, выступающим за пределы резонаторного корпуса частью струнного щипкового или смычкового музыкального инструмента.',
	],
	[
	...
	[
		'звукосниматель',
		'являяется',
		'устройством,  преобразующее колебания струн в электрический ток. По принципу действия звукосниматели делятся на электромагнитные, пьезоэлектрические и оптические .',
	],
	[
	...
	[
		'недостатками у магнитных звукоснимателей',
		'являются',
		' некоторые зависимости электрических параметров (в основном добротности и резонансной частоты) от параметров подключенных внешних устройств (усилитель) и линий коммутации (кабель) и наведенных на них шумов'
	],
	[
		'лес пол',
		'является',
		' американским гитарист-виртуозом, поэтом-песенником, новатор в области звукозаписи, один из изобретателей электрогитары, которая сделала возможным современное звучание рок-н-ролла и рок-музыки, а также некоторых направлений джаза'
	],
	[
	...
	[
		'колки',
		'являются',
		'деталью струнных музыкальных инструментов в виде небольшого стержня для закрепления и натяжения струны. Противоположные концы струн прикрепляются к струнодержателю'
	],
	[
		'колки',
		'работают',
	...
	[
		'бридж',
		'является',
		'струнодержателем или нижним порожеком для электрогитары'
	],
	[
		'бридж',
		'выполняет',
	...
	[
		...
		'являются',
		'составной частью струнодержателя или бриджа'
	],
	[
		'стреплок',
		'является',
		'специальным приспособлением для крепления гитарного ремня к инструменту. Благодаря этому гитара может висеть на плече и не спадать. '
	],
	[
		'электрогитары',
		'бывают',
	...
	[
		'табулатура',
		'является',
		'типом музыкальной нотации, схематической записью музыки для клавишных, некоторых струнных и духовых инструментов. Табулатура оперирует рабочими элементами музыкального инструмента. Для сокращения записи в табулатуре применяются буквы, цифры и специальные символы'
	],
	[
...
[
	...
	'нужна',
	'Чтобы звук был чище, и отсутствовали различные помехи, рекомендуется приобрести жилы, выполненные из меди. Чем толще данный материал, тем лучше будет звучать музыкальный инструмент. Их толщина также положительно влияет на устранение внешних шумов или скрипов'
],
[
...
[
	'pur a flex',
	'является',
	'современным термопластичный материал, производимый из практичного полиуретана. Для данного вещества характерен высокий показатель устойчивости к внешнему воздействию, включая перепады температурного режима, влажность и частые механические нагрузки'
],
[
	'frnc',
	'является',
	'современным термопластичный материалом, производимый из практичного полиуретана. Для данного вещества характерен высокий показатель устойчивости к внешнему воздействию, включая перепады температурного режима, влажность и частые механические нагрузки'
],
...
[
	'формы комбоусилителей',
	'бывают',
	'в двух основных формах: комбинированный (или комбо) усилитель содержит электронную схему усилителя и акустическую воспроизводящую систему в одном корпусе. В другой форме усилитель расположен в отдельном корпусе и подключается к акустической системе с помощью соединительного провода'
],
[
	'гольпеадор',
	'является',
	'защитной пленкой или тонкой пластиной из пластмассы, закрепленная на верхней деке гитары; обычно под резонаторным отверстием'
],
[
	'слово электрогитара',
	'произошло',
	'от слияния двух слов: санскритского слова «сангита», что означает «музыка» и древнеперсидского «тар», означающего «струна». По другой версии, слово «гитара» происходит от санскритского слова «кутур», означающего «четырехструнный»'
],
[
	'звук в электрогитаре',
	'образуется',
	'при вибрации струны, которую мы приводим в движение при помощи медиатора или пальцев. Шесть струн электрогитары отличаются своей толщиной. Самая тонкая струна находится в самом низу и называется первой струной, на ней мы играем более высокие ноты'
],
//100
];
...
function getAnswer(question) {
	...
	if (!result) answer[0] = 'ответа не существует';
	return answer;
}
